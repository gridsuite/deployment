...
PS : if you have rights restrictions, [you can download a .deb package and install it for minikube](https://minikube.sigs.k8s.io/docs/start/), and [use snap for kubectl](https://kubernetes.io/docs/tasks/tools/install-kubectl-linux/#install-using-other-package-management).
